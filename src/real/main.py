...
if "--trt-engine" not in sys.argv:
    sys.argv.extend(["--trt-engine", "src/real/models/yolo11n-pose-fp16.trt"])
...
if "--stairs-model" not in sys.argv:
    ...
    _stairs_engine = "src/real/models/yolov8s-worldv2.engine"
    _stairs_pt = "src/real/models/yolov8s-worldv2.pt"
