...
This module contains :class:`DualCameraSystem` (the top-level system object) and
the :data:`AlignedFramesTuple` type alias it uses. Both are imported and
re-exported by :mod:`dual_camera_system`.
"""
...
from dual_camera_calibrator import DualCameraCalibrator
