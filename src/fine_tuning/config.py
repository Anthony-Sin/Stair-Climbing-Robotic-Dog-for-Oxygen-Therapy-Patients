...
class FineTuneConfig:
    # --- paths -------------------------------------------------------------
    base_jit_path: str = sim_model_source.DEFAULT_BASE_JIT
    vision_weight_path: str = sim_model_source.DEFAULT_VISION_WEIGHT
    config_json_path: str = sim_model_source.DEFAULT_CONFIG_JSON
    output_dir: str = str(Path(sim_model_source.REPO_ROOT) / "fine_tuning" / "checkpoints")
    runs_dir: str = str(Path(sim_model_source.REPO_ROOT) / "fine_tuning" / "runs")
