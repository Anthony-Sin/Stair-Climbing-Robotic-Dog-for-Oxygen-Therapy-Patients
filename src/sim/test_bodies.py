...
print("BODY NAMES:")
# Get body prim paths
for i in range(patient_art.num_dof):
    pass # we can access via view

# Let's inspect the rigid bodies in the articulation view
view = patient_art._articulation_view
print("Body names in view:", view.body_names)

# Get the initial poses of all bodies
poses = view.get_world_poses()
for name, pos, rot in zip(view.body_names, poses[0], poses[1]):
