...
# Apply uniform scale WITHOUT clearing other ops
stage = omni.usd.get_context().get_stage()
prim = stage.GetPrimAtPath(prim_path)
scale = 1.70 / 1.78
xform = UsdGeom.Xformable(prim)

# Let's see what ops exist before
print("Ops before:", [op.GetOpType() for op in xform.GetOrderedXformOps()])
...
print("Ops after:", [op.GetOpType() for op in xform.GetOrderedXformOps()])
